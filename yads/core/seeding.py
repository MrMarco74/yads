...
def seed_changelog():
    with Session(engine) as session:
        ...
        if not session.query(ChangelogEntry).where(ChangelogEntry.version == "1.14.0").first():




            entry_1140 = ChangelogEntry(




                title="YADS v1.14.0: Pipeline Bugfixes",
